...
#copied and adapetd from https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/embeddings.py
import math
...
class PatchEmbed(nn.Module):
    ...
    def forward(self, latent):
        ...
        return (latent + pos_embed.to(latent.dtype)).to(latent.dtype)
